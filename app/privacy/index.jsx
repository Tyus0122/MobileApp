		...
		<SafeAreaView>
			...
			>
				...
				<View className="m-5">
					...
					<View>
						<Text className="text-base mt-5 mb-3">
						...
						/>
						<Text className="text-base mt-5 mb-3">a. Personal Information</Text>
						<Text className="text-base text-gray-700 mt-3">
							We may collect personal information that you voluntarily provide,
							such as:
						</Text>
						<Text className="ml-5 text-base mt-2">
							● Name{"\n"}● Email address{"\n"}● Phone number {"\n"}● Profile
							information
						</Text>
						<Text className="text-base mt-5 mb-3">b. Usage Data</Text>
						<Text className="text-base text-gray-700 mt-3">
						...
						<Text className="text-base mt-5 mb-3">c. Location Data</Text>
						<Text className="text-base text-gray-700 mt-3">
							With your permission, we may collect location data to provide
							location-based services, such as nearby accommodations.
						</Text>
						<Text className="text-base mt-5 mb-3">d. Third-Party Services</Text>
						<Text className="text-base text-gray-700 mt-3">
					...
					<View>
						<Text className="text-base mt-5 mb-3">4. Data Security</Text>
						<Image
							source={pp4}
							style={{
								width: "50%",
					...
					<View>
						<Text className="text-base mt-5 mb-3">7. Contact Us</Text>
						<Text className="text-base text-gray-700 mt-3">
