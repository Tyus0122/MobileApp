			...
			>
				...
				<View className="m-5">
					...
					<View>
						...
						<Text className="text-base text-gray-700 mt-3">● You agree to:</Text>
						<Text className="text-base text-gray-700 mt-3 ml-5">
					...
					>
						...
						/>
						<Text className="text-base ">agree to terms and conditions</Text>
					</Pressable>
					{showError && (
						<Text className="text-base text-red-500 mt-2">
